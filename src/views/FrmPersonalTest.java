...
public class FrmPersonalTest extends JFrame implements ActionListener, WindowListener, MouseListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmPersonalTest frame = new FrmPersonalTest();
