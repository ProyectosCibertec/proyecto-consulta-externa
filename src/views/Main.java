...
public class Main extends JFrame
		implements MouseListener, ActionListener, WindowListener, PropertyChangeListener, ComponentListener {
	...
	public Main() {
		...
		imageIcon = new ImageIcon(new ImageIcon(Main.class.getResource("/assets/images/slide1.jpg")).getImage()
		...
		lblUser.setText(PERSONAL_NAME);

		setLocationRelativeTo(null);
	}

	public static String USER_ID, PERSONAL_ID, PERSONAL_NAME;
	...
	protected void windowOpenedThis(WindowEvent e) {
		imageIcon = new ImageIcon(new ImageIcon(Main.class.getResource("/assets/images/slide1.jpg")).getImage()
				.getScaledInstance(lblImage.getWidth(), lblImage.getHeight(), Image.SCALE_DEFAULT));
		lblImage.setIcon(imageIcon);
	}
